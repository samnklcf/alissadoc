...
function Marketing() {
  ...
  const getData = useCallback(async () => {
    if (user_token) {
      let response = await fetch(
        "https://alissadata.pythonanywhere.com/data/business",
        {
          method: "GET",
          headers: {
  ...
  const titre = donne && donne.titre;
  const content = donne && donne.contenu;
  const date = donne && donne.datetime;
  ...
  return (
    <>
      ...
      <main id="main" className="main">
        ...
        <Link type="button" className="btn btn-outline-primary" href={"/business"}>
          Créer <b>+</b>
        </Link>
