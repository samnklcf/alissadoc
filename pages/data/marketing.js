...
function Marketing() {
  ...
  const getData = useCallback(async () => {
    if (user_token) {
      let response = await fetch("https://alissadata.pythonanywhere.com/data/marketing", {
        method: "GET",
        headers: {
  ...
  return (
    <>
      ...
      <main id="main" className="main">
        ...
        <Link type="button" className="btn btn-outline-primary" href={"/marketing"}>
          Créer <b>+</b>
        </Link>
        <br />
        <br />
                      ...
                      <div className="modal-content">
                        <div className="modal-header">
                          <span className="modal-title">
                            Titre: <b>{titre}</b> <br /> <i className="minil">Type: {types}</i> <br /> <i className="minil">du {dateStr}</i>
                          </span>
                          <button
                            type="button"
                            className="btn-close"
